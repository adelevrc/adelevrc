...
const AboutMe = () => (
  <main className={styles.main}>
    ...
    <div className={styles.history}>
      <section>
        <h2>Mon histoire : aller mieux grâce au yoga</h2>
        <p>
          ...
          moyen de retrouver un état de bien être et de gérer mon quotidien.{" "}
        </p>
        <p>
          ...
          me sentir mieux, à retrouver une meilleure qualité de sommeil et dans
          ma vie quotidienne.
        </p>
        <p>
          ...
          sur le cerveau,la neuroscience, la les bienfaits de la respiration, la
          méditation, ainsi que sur l'anatomie et la biomécanique. Plus
          j'approfondissais mes recherches, plus je tombais amoureuse du yoga
          dans sa globalité : une pratique qui allie mouvement, anatomie et
          esprit.{" "}
        </p>
        <ButtonLink
    ...
    <div className={styles.secondSection}>
      <section>
        ...
        <p>
          ...
          et le corps. Le yoga ne se limite pas à une série de posture; En plus
          de l'aspect traditionnel et rituel, c'est une science du mouvement qui
          prend en compte la biomécanique, les neurosciences, et la manière dont
          notre corps et notre esprit font partie de la même entité. Grâce à
          cette pratique, j'ai appris à gérer mon stress et mes émotions, à me
          reconnecter et à mieux gérer les défis du quotidien.
        </p>
        ...
        <p>
          ...
          neurosciences pour créer des séquences originales, dynamiques avec des
          objectifs précis.
        </p>
        <p>
          Aujourd'hui, je suis convaincue que tout le monde peut bénéficier du
          yoga, qu'on fasse de la course, de la musculation, du pilate, ou rien
          du tout, le yoga est là comme un ami qui nous aide à améliorer notre
          corps, notre santé, notre bien-être mais aussi à gérer nos émotions et
          à vivre en société.
        </p>

        <ButtonLink title={"Les cours"} href={"les-cours"} color='red' />
      </section>
    </div>
  </main>
);
